...
import { ROUTES } from "../utils/Constants/routes";
import { NAMES } from "../utils/Constants/text";
import { ComandaDashboard } from "../utils/types/ComandaTypes"; // ¡CAMBIO AQUÍ!
import { User } from "../utils/types/UserTypes"; // ¡CAMBIO AQUÍ!
// Las interfaces comentadas se eliminan
// export interface ComandaDashboard {
//   id: number;
//   fecha: string;
//   estado: "abierta" | "cerrada";
