...
import { useState, useEffect, useCallback } from "react";
import api from "../api/axio";
import { ProductoProps, NuevoProductoData } from "../utils/types/ComandaTypes"; // ¡CAMBIO AQUÍ!
import { CategoriaProps } from "../utils/types/CategoriaTypes"; // ¡CAMBIO AQUÍ!
import { ROUTES } from "../utils/Constants/routes";
import { NAMES } from "../utils/Constants/text";
// Se elimina la declaración local de NuevoProductoData
// export type NuevoProductoData = Omit<ProductoProps, "id">;
