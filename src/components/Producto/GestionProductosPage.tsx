...
// src/components/GestionProductosPage/GestionProductosPage.tsx
...
// CAMBIO NECESARIO: Importar ProductoProps desde utils/types/ComandaTypes.ts
import { ProductoProps } from "../../utils/types/ComandaTypes"; // <--- AÑADE ESTA LÍNEA
    ...
    <div className={styles.gestionProductosContainer}>
      ...
      {!editandoProductoId && (
        <>
          ...
          <FormularioProducto
            onSubmit={async (data) => {
              // Aquí 'data' es NuevoProductoData | ProductoProps.
              // Omitir 'id' si estás creando, o pasarlo si es una edición.
              // El tipo 'any' es un workaround si TypeScript se queja mucho.
              // Idealmente, deberías tipar 'data' como NuevoProductoData aquí.
              const { id, ...productoDataParaCrear } = data as ProductoProps; // Si es crear, 'id' no existirá o será 0
              return await handleCrearProducto(productoDataParaCrear);
            }}
            categoriasDisponibles={categorias}
            textoBotonSubmit={NAMES.PRODUCTO_GUARDAR}
