...
//     const success = await onSubmit(formData);
//     if (success && !productoInicial) {
//       setFormData({ nombre: "", precio: 0, categoria_id: 0 }); // Resetear solo si es un formulario de creación
//     }
//   };
...
//           text={textoBotonSubmit}
//           type="submit"
//           className={styles.saveButton} // Usar clase específica para guardar
//         />
//         {onCancel && (
//           <Button
//             text={NAMES.CANCELAR}
//             onClick={onCancel}
//             type="button"
//             className={styles.cancelButton} // Usar clase específica para cancelar
//           />
//         )}
//       </div>
//     </form>
...
// export default FormularioProducto;
// components/Producto/FormularioProducto.tsx
import React, { useState, useEffect } from "react";
import Button from "../Button/Button";
import styles from "./Producto.module.css";
import { NAMES } from "../../utils/Constants/text";
    ...
    <form onSubmit={handleSubmit} className={styles.formContainer}>
      ...
      <div className={styles.buttonGroup}>
        <Button
          text={textoBotonSubmit}
          type="submit"
          // AHORA: Usa styles.button + styles.saveButton
        ...
        {onCancel && (
          <Button
            ...
            onClick={onCancel}
            type="button"
            // AHORA: Usa styles.button + styles.cancelButton
            className={`${styles.button} ${styles.cancelButton}`}
          />
        )}
      </div>
