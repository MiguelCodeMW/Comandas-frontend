...
import { ROUTES } from "../../utils/Constants/routes";
import { NAMES } from "../../utils/Constants/text";
import { useGestionCategorias } from "../../hooks/useGestionCategorias"; // Asegúrate de que este hook esté actualizado internamente con los nuevos tipos si usa alguno de ellos.
...
function GestionCategoriasPage() {
  const {
    ...
    cancelarEdicion,
    handleEditarCategoria,
    handleEliminarCategoriaCallback, // Este es el callback del hook
    limpiarMensajes,
  } = useGestionCategorias();
  const navigate = useNavigate();
  ...
  return (
    <div className={styles.container}>
      ...
      <CategoriaList
        ...
        onCategoriaEditada={handleEditarCategoria}
        onCancelar={cancelarEdicion}
        onEliminar={handleEliminarCategoriaCallback} // Mapeado a la nueva prop `onEliminar`
        limpiarMensajesAlCambiar={limpiarMensajes}
      />
      <div
        style={{
